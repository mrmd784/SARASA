	...
	Select 1,'33000013','33','2023-10-24','33241023',tb_Item.Supp_Code,tb_DwnStock.ItemCode,tb_Item.Descrip,'Each',1,tb_DwnStock.Cost,tb_DwnStock.Price,tb_DwnStock.Balance,tb_DwnStock.Balance*tb_DwnStock.Cost,tb_DwnStock.Balance*tb_DwnStock.Price,Getdate(),'ADD','',1,Null,Null,tb_DwnStock.CScode
...
--Stock Reduce
	...
	Insert Into tb_StAdjDet([LnNo],[SerialNo],[LocaCode],[IDate],[RefNo],[SuppCode],[ItemCode],[ItemDescrip],[Scale],[PackSize],[Cost],[Rate],[Qty],[CostValue],[RetValue],[TrDate],[ID],[Remark],[Status],[ExpDate],[BatchNo],[CScode])
	Select 1,'33000014','33','2023-10-24','33241023',tb_Item.Supp_Code,tb_DwnStock.ItemCode,tb_Item.Descrip,'Each',1,tb_DwnStock.Cost,tb_DwnStock.Price,Abs(tb_DwnStock.Balance),Abs(tb_DwnStock.Balance)*tb_DwnStock.Cost,Abs(tb_DwnStock.Balance)*tb_DwnStock.Price,Getdate(),'DSC','',1,Null,Null,tb_DwnStock.CScode
	From tb_DwnStock Join tb_Item On tb_DwnStock.ItemCode=tb_item.Item_Code Where tb_DwnStock.Balance<0
