...
Where Status=1 And SaleType='S' And Upload='E' and loca='03'   Group By UnitNo,LOCA
--1175550

Select Isnull(Sum(Case Iid When '001' Then qty
When '002' Then -Qty Else 0 End),0) AS qty  From tbPosTransact 
Where Status=1 And SaleType='S' And Upload='E' and loca='03'  Group By UnitNo 
--317
...
select * from tbpostransact where loca=03 and upload='F' and  ZNo in('2146')
update tbPostransact set Upload='E' where loca='03' and Upload='F' and ZNo in('2146')
update tbPospayment set Upload='E' where loca='03' and Upload='F' and ZNo in('2146')
...
From tbPostransact Where Upload='E'  And loca='03' and  Status = '1' Group By ItemCode,Cost,Price

--2.(Check Item not in easyway)
select * from tbPostransact Where Loca = '03' and Upload = 'E' and ItemCode not in(select item_code from tb_Item)

--3.
Update tb_DwnStock Set Nett = (Qty * Price)
Select SUM(Nett) From tb_DwnStock  ---1175550.00

--4.Update Document no for Stock Adjestment
Select * From tb_System Where LocaCode = '03'    --3743
update tb_System set OPB='3744' Where LocaCode = '03'


--5.Check If There Any Transactions After Stock Take
delete from tbPostransact where Upload='E' and Serial<>'H002'


UPDATE C  SET  C.serial=D.Supp_Code FROM  TB_ITEM  AS  D  JOIN tbPostransact AS C ON D.ITEM_CODE=C.ITEMCODE where c.upload='E'
...
Select * From tb_Stock Where LocaCode = '03' And Status = '1' and batchno='H002' order by pdate desc

--6.Stock Zero
Update tb_Stock Set Status = '9', TourCode = 'STK25/23' Where LocaCode = '03' And Status = '1' and BatchNo='H002'
...
Select
	'03'+'003744','03','OB' + Convert(Varchar(10),'2023-06-25'),'2023-06-25',Rtrim(I.Supp_Code),Null,'StkUp'
...
Select	 	             '03003744',   '03'   ,'OPBSTK','2023-06-25',I.Supp_Code,D.ItemCode,I.Inv_Descrip,'Each' ,'StockUP' ,E.Cost_Price,E.ERet_Price,D.Qty,(D.Qty*E.Cost_Price),(D.Qty*E.ERet_Price),GetDate(),'OPB',   '1'  ,  '1' ,    '1'   ,    ''   ,   ''
...
Select 					  '03003744',   '03'   ,'OP2023-06-25','2023-06-25',Sum(CostValue),Sum(RetValue),'OPB',  '1' ,   '1'  ,GetDate(),  'Sarasa'
From tb_StAdjDet Where LocaCode = '03' And SerialNo = '03003744'
