...
select *  from tbPostransact where loca='03' and upload='F' and UnitNo='3' and ZNo='2140' and Upload='F' is null
select Distinct Loca,UnitNo,zno from tbPostransact where loca='03' and upload='F'  UnitNo='3' and ZNo='2141' and Upload ='f'
...
update tbPostransact set Upload='A' where loca='03' and Upload='F' and ZNo in('2141')
update tbPospayment set Upload='A' where loca='03' and Upload='F' and ZNo in('2141')
...
From tbPostransact Where Upload='A'  And loca='03' and  Status = '1' Group By ItemCode,Cost,Price

--2.(Check Item not in easyway)
select * from tbPostransact Where Loca = '03' and Upload = 'A' and ItemCode not in(select item_code from tb_Item)
...
Select * From tb_System Where LocaCode = '03'    --3739
update tb_System set OPB='3740' Where LocaCode = '03'
...
Select * From tb_Stock Where LocaCode = '03' And Status = '1' and batchno is null order by pdate desc

--6.Stock Zero
Update tb_Stock Set Status = '9', TourCode = 'STK13/23' Where LocaCode = '03' And Status = '1' and BatchNo='E004'
...
Select
	'03'+'003740','03','OB' + Convert(Varchar(10),'2023-06-12'),'2023-06-12',Rtrim(I.Supp_Code),Null,'StkUp'
...
Select	 	             '03003740',   '03'   ,'OPBSTK','2023-06-12',I.Supp_Code,D.ItemCode,I.Inv_Descrip,'Each' ,'StockUP' ,E.Cost_Price,E.ERet_Price,D.Qty,(D.Qty*E.Cost_Price),(D.Qty*E.ERet_Price),GetDate(),'OPB',   '1'  ,  '1' ,    '1'   ,    ''   ,   ''
...
Select 					  '03003740',   '03'   ,'OP2023-06-12','2023-06-12',Sum(CostValue),Sum(RetValue),'OPB',  '1' ,   '1'  ,GetDate(),  'Sarasa'
From tb_StAdjDet Where LocaCode = '03' And SerialNo = '03003740'
