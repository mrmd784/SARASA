  ...
  --on ts.ProductID =t.productid
   ...
   select pm.ProductCode,pm.ProductName,cs.ColorSizeCode,cs.ColorSizeName,d.DepartmentName,c.CategoryName
   ...
   inner join InvProductColorSize cs 
   on pm.InvProductMasterID=cs.InvProductMasterID
   and  cs.InvProductColorSizeID=t.ColorSizeID
