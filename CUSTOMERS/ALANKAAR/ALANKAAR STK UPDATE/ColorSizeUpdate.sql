...
@CreatedUser VARCHAR(30)='SARASA'
			---Insert ProductDetails to Temp
			
		

					
			--INSERT INTO InvTmpProductStockDetailsColorSize (CompanyId, LocationId, GivenDate, ProductID, ProductCode, ProductName, CostPrice, SellingPrice, AverageCost, DepartmentID, 
			--	CategoryID, SubCategoryID, SubCategory2ID, SupplierID, StockQty, UserId, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, DataTransfer,ColorSizeID)
			--SELECT @CompanyId,@SelectedLocationID,@GivenDate, pm.InvProductMasterID, pm.ProductCode, pm.ProductName, pm.CostPrice, pm.SellingPrice, pm.AverageCost, pm.DepartmentID,
			--	pm.CategoryID, pm.SubCategoryID, pm.SubCategory2ID, pm.SupplierID, 0, @UserId, 0, 1, @CreatedUser, GETDATE(), @CreatedUser, GETDATE(), 0,cs.InvProductColorSizeID 
	...
	declare @StockDate DateTime='2023-06-20'
