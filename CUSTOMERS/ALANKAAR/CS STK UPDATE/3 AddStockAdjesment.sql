...
SET @documentNo = 'STAM' + @LocationCode + '000000019';
SET @StockAdjustmentMode=2;

--select * from [InvStockAdjustmentHeader]  where DocumentNo like '%STAM%'
...
INSERT INTO [dbo].[InvStockAdjustmentDetail]
  ...
  SELECT
           ...
           ,sta.InvProductColorSizeID--<InvProductColorSizeID, bigint,>
...
INSERT INTO [dbo].[InvStockAdjustmentDetail]
  ...
  SELECT
           ...
           ,star.InvProductColorSizeID--<InvProductColorSizeID, bigint,>
           ,@DocumentID--<DocumentID, int,>
           ,@documentNo--<DocumentNo, nvarchar(20),>
           ,@ZDate--<DocumentDate, datetime,>
           ,@StockAdjustmentMode--<StockAdjustmentMode, int,>
...
EXEC spCalculateCurrentStock   -- stockupdate
