...
/****** Object:  StoredProcedure [dbo].[SP_DOWNLOAD_MASTER]    Script Date: 11/09/2023 15:56:40 ******/
SET ANSI_NULLS ON
GO
...
OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Supplier_Rpl)WHERE Idx>@lastid Order By Idx
...
OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Link1_Rpl)
...
OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Link2_Rpl)
WHERE Idx>@lastid Order By Idx
...
OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Link3_Rpl)
WHERE Idx>@lastid Order By Idx
...
OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Link4_Rpl)
WHERE Idx>@lastid Order By Idx
...
OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Category_Rpl)WHERE Idx>@lastid Order By Idx
...
OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_SubCategory_Rpl)WHERE Idx>@lastid Order By Idx
...
DECLARE curItem CURSOR FOR Select Item_Code,Ref_Code,Barcode,Inv_Descrip,Descrip,Cat_Code,SubCat_Code,L1_Code,L2_Code,L3_Code,L4_Code,L5_Code,L6_Code,L7_Code,Supp_Code,Pack_Size,W_Margine,R_Margine,
	PUnit,EUnit,Tax1,Tax2,Tax3,MaxPrice,Countable,Use_Exp,ComRate,ItemType,ConvertFact,ConvertFactUnit,Idx,Consign,OpenPrice,AutoSerial,isCombined,isTaxApply,Intergration_Upload
       from 
	OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Item_Rpl)WHERE Idx>@lastid Order By Idx
...
DECLARE curItemDet CURSOR FOR 
	...
	OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_ItemDet_Rpl)WHERE loca_code='01' and Idx>@lastid Order By Idx
...
DECLARE curItemColour CURSOR FOR 
	...
	OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_Colour_Size)WHERE locacode='01' and Idx>@lastid Order By Idx
...
DECLARE curRep CURSOR FOR 
	...
	OpenRowset('Sqloledb','124.43.76.88';'sa';'tstc123',EasyWay.Dbo.tb_SalesRep_Rpl)WHERE Idx>@lastid Order By Idx
